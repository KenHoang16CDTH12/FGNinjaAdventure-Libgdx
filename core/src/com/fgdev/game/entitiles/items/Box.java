...
import static com.fgdev.game.util.Constants.PLAYER_BIT;

public class Box extends ItemTileObject {

    private static String TAG = Box.class.getName();

    private TextureRegion box;

    public Box(World world, MapObject object) {
        super(world, object);
        box = Assets.instance.item.box;
